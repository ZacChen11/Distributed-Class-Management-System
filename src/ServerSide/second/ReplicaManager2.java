		...
		try {
			...
			while(true){
				...
				{	
					...
					if(restart_counter == 2){
						...
						if(flag_leader == true)
						{
							...
							sendUDPRequest(RC,msg,0003);
							flag_leader = false;
							FrontEnd.leader2 = false;
							CenterServerMTL2.flag_reply = false;
							CenterServerLVL2.flag_reply = false;
							CenterServerDDO2.flag_reply = false;
							RM3 = true;
							ReplicaManager1.RM2 = false;
							ReplicaManager3.RM2 = false;
							ReplicaManager1.RM3 = true;
							System.out.println("GIVE : FE1: "+FrontEnd.leader1+" FE2: "+FrontEnd.leader2+" FE3: "+FrontEnd.leader3);
						}
				...
				if(request.contains("leader"))
				{
					...
					FrontEnd.leader2 = true;
					FrontEnd.leader1 = false;
					flag_leader = true;
					CenterServerMTL2.flag_reply = true;
					CenterServerLVL2.flag_reply = true;
					CenterServerDDO2.flag_reply = true;
					RM1 = false;
					RM3 = false;
					System.out.println("GET : FE1: "+FrontEnd.leader1+" FE2: "+FrontEnd.leader2+" FE3: "+FrontEnd.leader3);
					System.out.println("2: rm2: "+RM1+"/rm3: "+RM3 +"| 1: rm2: "+ReplicaManager1.RM2+"/rm3: "+ReplicaManager1.RM3+ "| 3: rm1: "+ReplicaManager3.RM1+"/rm2: "+ReplicaManager3.RM2);
				}
