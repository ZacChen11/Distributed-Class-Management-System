		...
		try {
			...
			while(true){
				...
				{	restart_counter++;
					...
					if(restart_counter == 2){
						...
						if(flag_leader == true)
						{
							...
							sendUDPRequest(RC,msg,0002);
							flag_leader = false;
							FrontEnd.leader1 = false;
							FrontEnd.leader2 = true;
							CenterServerMTL1.flag_reply = false;
							CenterServerLVL1.flag_reply = false;
							CenterServerDDO1.flag_reply = false;
							RM2 = true;
							ReplicaManager2.RM1 = false;
							ReplicaManager3.RM1 = false;
							ReplicaManager3.RM2 = true;
				...
				if(request.contains("leader"))
				{
					...
					FrontEnd.leader1 = true;
					flag_leader = true;
					CenterServerMTL1.flag_reply = true;
					CenterServerLVL1.flag_reply = true;
					CenterServerDDO1.flag_reply = true;
					RM2 = false;
					RM3 = false;
